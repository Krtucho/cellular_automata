...
\begin{figure}[p]
    \begin{center}
    \subfigure[Crecimiento m\'inimo $K_a=6$.$944 \times 10^1$]{\scalebox{0.5}{\includegraphics{img/automata/1.1.1.png}}}
    \subfigure[Crecimiento promedio $K_a=2$.$222 \times 10^2$]{\scalebox{0.5}{\includegraphics{img/automata/2.2.2.png}}}
    \subfigure[Crecimiento m\'aximo $K_a=4$.$938 \times 10^2$]{\scalebox{0.5}{\includegraphics{img/automata/3.3.3.png}}}
...
\begin{figure}[p]
    \begin{center}
    \subfigure[Crecimiento m\'inimo $K_a=6$.$944 \times 10^1$]{\scalebox{0.5}{\includegraphics{img/automata/4.4.4.png}}}
    \subfigure[Crecimiento promedio $K_a=2$.$222 \times 10^2$]{\scalebox{0.5}{\includegraphics{img/automata/5.5.5.png}}}
    \subfigure[Crecimiento m\'aximo $K_a=4$.$938 \times 10^2$]{\scalebox{0.5}{\includegraphics{img/automata/6.6.6.png}}}
    \end{center}\vspace*{-0.6cm}
...
\begin{figure}[p]
    \begin{center}
    \subfigure[Crecimiento m\'inimo $K_a=6$.$944 \times 10^1$]{\scalebox{0.5}{\includegraphics{img/automata/7.7.7.png}}}
    \subfigure[Crecimiento promedio $K_a=2$.$222 \times 10^2$]{\scalebox{0.5}{\includegraphics{img/automata/8.8.8.png}}}
    \subfigure[Crecimiento m\'aximo $K_a=4$.$938 \times 10^2$]{\scalebox{0.5}{\includegraphics{img/automata/9.9.9.png}}}
    \end{center}\vspace*{-0.6cm}
