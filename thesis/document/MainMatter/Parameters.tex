...
\subsection{Configuraciones y Par\'ametros de la simulaci\'on.}

Ademas de los parametros antes mencionados, algunos de los par\'ametros y configuraciones que se pueden modificar son:
\begin{itemize}
